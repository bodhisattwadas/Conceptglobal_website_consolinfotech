...
?>				
		...
		<section id="home" class="home_video html-video">
			<video muted="" autoplay="" loop="" style="width: 100%; height: 100%; object-fit: cover; position: absolute; top: 0; left: 0;">
				<source type="video/mp4" src="assets/videos/loader.mp4">
				...
				<div class="row feature_bg">
					...
					<div class="col-lg-4 col-sm-6 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s" data-wow-offset="0">
						<div class="single_feature">
							...
							<p>Expert consulting to help you create long-term technology roadmaps that align with your business growth goals.</p>
						</div>
					</div><!-- END COL -->	
				</div><!-- END ROW -->				
			</div><!--- END CONTAINER -->
		...
		<section id="portfolio" class="portfolio_area section-padding">
		   <div class="container-fluid">
				<div class="section-title text-center">
					<h2>Real Business Problems. Practical Technology Results.</h2>
					<p>See how we've helped businesses improve efficiency, reporting, and automation through tailored IT solutions.</p>
				</div>	
				<div class="col-lg-12 text-center">
					<div class="portfolio_filter">
						<ul>
							<li class="active filter" data-filter="all">All</li>
							<li class="filter" data-filter=".automation">Automation</li>
							<li class="filter" data-filter=".cloud">Cloud</li>
					...
					<div class="col-lg-5 col-sm-8 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="skill_bg">
							<div class="skill_content">
								<h2>Operational Excellence Through Technology</h2>
								<p>We don't just write code; we build operational advantages. Our team combines technical mastery with deep business insight to solve complex workflow challenges and drive measurable growth.</p>
							</div>	
							<div class="skill_bar">
								<div class="progress-bar-linear">
									<p class="progress-bar-text">Custom Business Apps
										<span>95%</span>
									</p>
								...
								<div class="progress-bar-linear">
									<p class="progress-bar-text">Process Automation
										<span>90%</span>
									</p>
									<div class="progress-bar">
								...
								<div class="progress-bar-linear">
									<p class="progress-bar-text">Cloud Strategy
										<span>85%</span>
									</p>
									<div class="progress-bar">
				...
				<div class="row">						
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="promotional_content">
							...
							<p>Our roots in finance and operations mean we understand the 'why' behind the technology. We focus on systems that reduce manual workload, eliminate reporting delays, and provide clear visibility into your core growth metrics, ensuring your IT investment delivers a tangible return.</p>
						</div>
					</div><!-- END COL -->
				</div><!-- END ROW -->				
			</div><!--- END CONTAINER -->
