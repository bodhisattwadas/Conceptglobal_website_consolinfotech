				...
				<div class="row text-center">					
					<div class="offset-lg-1 col-lg-10 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_about_content">
							<h2>Technology Backed by Business Understanding</h2>
							<p>Concept Global Infotech represents the natural evolution of our deep roots in accounting and financial process support. We combine operational understanding across industries with technical expertise to create practical systems that reduce manual work and improve business performance. Our team brings together business insight and technical skill to ensure every solution we deliver is secure, scalable, and built for your long-term growth.</p>
						</div>
					</div><!-- END COL -->					
				</div><!-- END ROW -->				
			</div><!--- END CONTAINER -->
				...
				<div class="row text-center">					
					<div class="col-lg-4 col-sm-6 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_feature">
							...
							<h4>Business Minded</h4>
							<p>We understand business operations first. Our technical solutions are built to solve real business friction.</p>
						</div>
					</div><!-- END COL -->				
					<div class="col-lg-4 col-sm-6 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_feature">
							...
							<p>A clear, structured process ensures that every project is delivered securely and on time.</p>
						</div>
					</div><!-- END COL -->				
					<div class="col-lg-4 col-sm-6 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_feature">
							...
							<p>We build systems that don't just work for today—they scale as your business expands.</p>
						</div>
					</div><!-- END COL -->				
				</div><!-- END ROW -->				
			</div><!--- END CONTAINER -->
